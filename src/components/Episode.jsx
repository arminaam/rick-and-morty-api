...
function Episode({ episode, Opencharacterpage, isLoadEpisodes }) {
  ...
  return (
    <div className="episode p-8 flex flex-col justify-center items-center bg-[#C3C3C3] border-[#4C4B63] border desktop_4k:w-[98%] desktop_1440:w-[97%] desktop_1024:w-[96%] tablet:w-[96%] h-[95%] rounded-lg shadow-2xl">
      {loading ? (
        ...
        <div className="characters h-[100%] overflow-y-auto w-[95%]">
          <div className="info desktop_4k:text-[1.75rem] desktop_1440:text-[1.25rem]  desktop_1024:text-[1rem]  tablet:text-[13px]   px-4 text-[#4C4B63]">
          ...
          <div className="grid  desktop_4k:grid-cols-6  desktop_1440:grid-cols-5 desktop_1024:grid-cols-4 tablet:grid-cols-3 gap-[1.7rem] justify-items-center max-h-[34.5rem] p-4">
            {characters.map((ch) => (
...
function Charatcter({ ch_info, Opencharacterpage }) {
  return (
    ...
    >
      ...
      <span className="min-[2560px]:text-2xl min-[1440px]:text-xl lg:text-[13px] tablet:text-[13px] text-center  font-bold">
        {ch_info.name}
      </span>
      <div className="text-center">
        <span className="min-[2560px]:text-lg  min-[1440px]:text-sm  lg:text-[11px] tablet:text-[11px]  font-semibold">
